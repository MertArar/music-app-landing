...
const MusicPlayer = () => {
  return (
    <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232a4e] rounded-xl -mt-0.5">
      {/* UPPER PART */}
      <div className="upperPart flex items-center justify-between mt-5">
        {/* PROFILE  */}
